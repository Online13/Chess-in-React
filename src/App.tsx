...
import { chessComPresets } from "./modules/chess-board/presentation/presets/chess-com-presets";
import { lichessPresets } from "./modules/chess-board/presentation/presets/lichess-presets";
...
function CustomBoard({
	...
	const [customGame, setCustomGame] = useState<Variant>(game);
