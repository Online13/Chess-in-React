/**
 * SVG sources: https://commons.wikimedia.org/wiki/Category:SVG_chess_pieces
 * 
 * Thanks to 
 * 
 */
...
export function WhitePawn({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function BlackPawn({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function WhiteRook({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function BlackRook({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function WhiteKnight({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function BlackKnight({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function WhiteBishop({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function BlackBishop({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function WhiteQueen({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function BlackQueen({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function WhiteKing({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
...
export function BlackKing({ className, title }: ChessPieceSvgProps) {
	return (
		<svg
			viewBox="0 0 45 45"
			className={className}
